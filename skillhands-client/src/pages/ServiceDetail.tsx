          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-6 mb-8">
              {serviceData.trustBadges.map((badge, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-2 bg-primary-foreground/10 px-4 py-2 rounded-lg"
                >
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            We'll call you within minutes of your request to
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            Licensed, insured professionals with the right tools
                            and expertise.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            We stand behind our work with satisfaction
                            guarantees.
                          </p>
                        </div>
                      </div>
                ...
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      No account required. Just tell us what you need and we'll
                      connect you with a local pro.
                    </p>
                    <PrimaryButton
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <PrimaryButton
                      ...
                      className="w-full"
                      onClick={() => {
                        const message = `Hi! I need help with ${serviceData.title
                          .toLowerCase()
                          .replace(/\s+/g, "-")
                          .replace("&", "and")
                          .replace(/\//g, "-")
