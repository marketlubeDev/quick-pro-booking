...
const Projects = () => {
  const allProjects = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1615870216519-2f9fa76b15f7?w=600&h=400&fit=crop',
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 lg:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            Explore our portfolio of successful home service projects. Each project showcases 
