...
const ServiceDetailView = () => {
  ...
  const serviceData = {
    ...
    description: 'Expert plumbing solutions for your home, from emergency repairs to new installations. Our licensed professionals provide reliable, efficient service.',
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="opacity-75">({serviceData.completedJobs} jobs)</span>
              </div>
            </div>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <Card>
                  <CardContent className="p-8">
                    <h2 className="font-heading text-2xl mb-6">Services We Provide</h2>
                ...
                <Card>
                  <CardContent className="p-8">
                    <h2 className="font-heading text-2xl mb-6">Why Choose Our Service</h2>
                ...
                <Card>
                  <CardContent className="p-8">
                    <h2 className="font-heading text-2xl mb-6">Service Areas</h2>
              ...
              <div className="space-y-6">
                ...
                <Card className="sticky top-24">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Book this service now and get a licensed professional at your door.
                    </p>
                    <PrimaryButton 
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-heading text-lg mb-4">Service Information</h3>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{serviceData.rating}/5 ⭐</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Jobs Completed</span>
                        <span className="font-semibold">{serviceData.completedJobs.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Response Time</span>
                        <span className="font-semibold">{serviceData.responseTime}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
